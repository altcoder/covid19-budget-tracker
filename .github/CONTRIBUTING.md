# Contributing to covid19-budget-tracker

Love covid19-budget-tracker and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/altcoder/covid19-budget-tracker/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/covid19-budget-tracker.git
   # Navigate to the newly cloned directory
   cd covid19-budget-tracker
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/altcoder/covid19-budget-tracker.git
   ```
